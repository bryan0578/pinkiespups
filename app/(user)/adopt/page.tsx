            ...
            <div className='max-w-7xl mx-auto p-4 lg:p-20'>
                <div>
                    ...
                    <ol className="text-left list-decimal pl-8 space-y-4">
                        ...
                        <li>Payment Confirmation: Pay the remaining balance of the adoption fee within 30 days of placing the deposit. We accept both online payments through our website and in-person payments.</li>
