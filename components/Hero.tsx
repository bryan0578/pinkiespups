        ...
        <div className="relative w-full flex flex-col lg:flex-row items-center lg:h-[100vh]">
            <div className='w-full flex justify-center lg:justify-end'>
                <div className='w-full max-w-[40rem] pr-0 ml-[5rem] mr-[5rem] lg:mr-[80px] max-lg:py-20'>
                    ...
                    <p className=' md:text-base lg:text-lg mb-6 lg:mb-8'>Welcome to our dog breeder website, where you can browse our adorable puppies for sale and find your new best friend.</p>
