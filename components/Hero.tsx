        ...
        <div className='w-full flex justify-center lg:justify-end'>
          <div className='w-full max-w-[40rem] pr-0 ml-[5rem] mr-[5rem] lg:mr-[80px] max-lg:py-20'>
            ...
            <div className='flex-start gap-x-3'>
              <Button className='w-[125px] h-[50px] bg-pink-500 hover:bg-pink-600 rounded-none text-white'>View Puppies</Button>
              <Button variant="outline" className='w-[125px] h-[50px] rounded-none text-pink-500 border-pink-500 border-2 hover:bg-pink-600 hover:border-none hover:text-white'>Contact Us</Button>
            </div>
          </div>
        </div>
