const PaymentDisclaimer = () => (
    <div className="w-full">
        <div>
            <h2 className="flex-center text-3xl font-bold py-6">Payment Disclaimer</h2>
            ...
            <p className="text-center text-xl mt-2"> Deposits will guarantee your puppy for 30 days only. If your adoption is not finalized 
