    ...
    return (
        <nav className={`flex-center fixed top-0 z-50 w-full border-b-4 border-pink-400 py-3 bg-gradient-to-r from-white to-pink-100`}>
            <div className='flex-between mx-auto w-full max-w-screen-2xl px-6 xs:px-8 sm:px-16'>
                ...
                <h1 className='hidden lg:block pl-4 text-pink-500 text-xl font-bold'>Pinky'sPups</h1>
                </Link>
                <Image
                ...
                <div className={`${!toggle ? "hidden" : "flex-start"} bg-gradient-to-r from-white to-pink-100 z-60 p-6 border-l-4 border-t-4 border-b-4 border-pink-400 absolute top-[66px] right-0 my-2 min-w-[50%] z-20 rounded-tl-lg rounded-bl-lg`}>
